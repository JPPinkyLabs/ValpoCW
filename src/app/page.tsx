...
export default function Home() {
  ...
  return (
    <>
      {/* ── HERO ── */}
      <section className="relative h-screen min-h-[600px] flex items-center px-6 md:px-12 pt-40 pb-8 overflow-hidden">
        {/* Animated mesh bg */}
        <div
      ...
      <section id="que-es" className="bg-gris relative overflow-hidden py-24 px-6 md:px-12">
        ...
        <div className="max-w-[1200px] mx-auto relative grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          <SectionReveal>
<div className="relative max-w-[400px] md:max-w-none aspect-[4/5] overflow-hidden">
  <Image
