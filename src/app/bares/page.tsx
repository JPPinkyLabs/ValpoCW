...
export const metadata: Metadata = {
  title: "Bares participantes",
  description:
    "Explora los 40+ bares participantes de la Valpo Cocktail Week 2026. Coctelería de autor en los cerros y el plan de Valparaíso.",
};
    ...
    <>
      ...
      <section className="py-20 px-6 md:px-12 bg-gris text-center">
        <div className="max-w-[600px] mx-auto">
          <p className="section-label text-center">¿Tienes un bar?</p>
          ...
          <Button href="/inscripcion">Quiero inscribir mi bar</Button>
        </div>
      </section>
    </>
  );
